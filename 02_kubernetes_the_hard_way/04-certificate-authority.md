...
# Éxecutez le code suivant pour chaque worker, instance=worker-<i>-<prenom>
EXTERNAL_IP=<IP EXTERNE INSTANCE>

INTERNAL_IP=<IP INTERNE INSTANCE>
...
KUBERNETES_PUBLIC_ADDRESS=<IP DE L'API> # utilisez ping ou dig par exemple
